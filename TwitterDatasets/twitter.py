...
# keywords_list = ['#Covid#Pandemy', '#Vaccine', '#S&P500', '#DowJones', '#StockMarket', '#NaturalDisaster', '#Pollution', '#War', '#RenewableEnergy', '#SmartCities']

keywords_list = ['#StockMarket', '#NaturalDisaster']
